...
class WatchListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        #fields = ["name", "id", "description"] #exclude active fields
        #exclude = ["active"]
...
#     #validation for complete object which is data
#     def validate(self,data):
#         if data["name"] == data["description"]:
#             raise serializers.ValidationError("Name and Description should be the different")
    
#     # #using validate_<field_name>
#     # #value is value of particular name
